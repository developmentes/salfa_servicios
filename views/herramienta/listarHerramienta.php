...
require_once("../../models/herramienta-models/HerramientaModel.php");

use models\HerramientaModel as HerramientaModel;

session_start();

$objHerramienta = new HerramientaModel();

$herramienta = $objHerramienta->getAllHerramientas();
            ...
            <div class="col-md-10">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <th><?= $h['nombre_herramienta'] ?></th>

                                <th><?= $h['marca_herramienta'] ?></th>

                                <th><?= $h['modelo_herramienta'] ?></th>

                                <th><?= $h['stock_herramienta'] ?></th>

                                <th><a href="./actualizarHerramienta.php?id=<?= $h['id_herramienta'] ?>" class="btn btn-info">Editar</a></th>

                                <th><a href="./eliminarHerramienta.php?id=<?= $h['id_herramienta'] ?>" class="btn btn-danger">Eliminar</a></th>

                                <th><a href="./asignarHerramienta.php?id=<?= $h['id_herramienta'] ?>" class="btn btn-warning">Asignar</a></th>
                            </tr>
                        <?php
                        }
                        ?>
